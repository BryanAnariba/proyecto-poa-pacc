        ...
        case 'POST':
            ...
            if ($tokenEsValido) {
                if (
                    ...
                    $descripcion->insertaNuevaDescripcionAdministrativa($_POST['idObjetoGasto'], $_POST['idTipoPresupuesto'], $_POST['idActividad'], $_POST['idDimension'], $_POST['cantidad'], $_POST['costo'], $_POST['costoTotal'], $_POST['mesRequerido'], $_POST['descripcion']);
                } else {
                    $descripcion = new DescripcionAdministrativaController();
