        ...
        case 'POST': 
            ...
            if ($tokenEsValido) {
                if (
                    ...
                    $llenadoActividadDimension->modificaNuevoRangoLlenadoActividad($_POST['idLlenadoDimension'], $_POST['valorLlenadoDimensionInicial'], $_POST['valorLlenadoDimensionFinal']);
                } else {
                    $llenadoActividadDimension = new LlenadoDimensionActividadController();
