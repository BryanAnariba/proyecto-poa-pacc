...
-- -----------------------------------------------------
-- Table `poa-pacc-bd`.`EstadoDCDU`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `poa-pacc-bd`.`EstadoDCDU` (
  `idEstadoDCDU` INT NOT NULL AUTO_INCREMENT,
  `estado` VARCHAR(45) NULL,
  PRIMARY KEY (`idEstadoDCDU`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `poa-pacc-bd`.`Departamento` (
  ...
  `idEstadoDCDU` INT NOT NULL,
  `nombreDepartamento` VARCHAR(80) NOT NULL,
  `abrev` VARCHAR(5) NOT NULL,
  PRIMARY KEY (`idDepartamento`),
  INDEX `fk_Departamento_EstadoDCD1_idx` (`idEstadoDCDU` ASC) VISIBLE,
  CONSTRAINT `fk_Departamento_EstadoDCD1`
    FOREIGN KEY (`idEstadoDCDU`)
    REFERENCES `poa-pacc-bd`.`EstadoDCDU` (`idEstadoDCDU`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `poa-pacc-bd`.`Usuario` (
  ...
  INDEX `fk_Usuario_EstadoDCDU1_idx` (`idEstadoDCDU` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `poa-pacc-bd`.`DimensionEstrategica` (
  ...
  `IdEstadoDCD` INT NOT NULL,
  `dimensionEstrategica` VARCHAR(150) NOT NULL,
  `idEstadoLLenado` INT NOT NULL,
  PRIMARY KEY (`idDimension`),
  INDEX `fk_DimensionEstrategica_EstadoDCD1_idx` (`IdEstadoDCD` ASC) VISIBLE,
  CONSTRAINT `fk_DimensionEstrategica_EstadoDCD1`
    FOREIGN KEY (`IdEstadoDCD`)
    REFERENCES `poa-pacc-bd`.`EstadoDCDU` (`idEstadoDCDU`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `poa-pacc-bd`.`ObjetivoInstitucional` (
  ...
  `objetivoInstitucional` VARCHAR(150) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `poa-pacc-bd`.`Carrera` (
  ...
  INDEX `fk_Carrera_EstadoDCD1_idx` (`idEstadoDCDU` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `poa-pacc-bd`.`PresupuestoDepartamento` (
  ...
  `idDepartamento` INT NOT NULL,
  `idControlPresupuestoActividad` INT NOT NULL,
  `montoPresupuesto` DECIMAL(8,2) NOT NULL,
  `fechaAprobacionPresupuesto` DATE NOT NULL,
...
CREATE TABLE IF NOT EXISTS `poa-pacc-bd`.`CostoActividadPorTrimestre` (
  ...
  `idActividad` INT NOT NULL,
  `porcentajeTrimestre1` DECIMAL(3,2) NOT NULL,
  `Trimestre1` DECIMAL(8,2) NULL,
  `abrevTrimestre1` VARCHAR(45) NOT NULL,
  `porcentajeTrimestre2` DECIMAL(8,2) NOT NULL,
  `Trimestre2` DECIMAL(8,2) NULL,
  `abrevTrimestre2` VARCHAR(45) NOT NULL,
  `porcentajeTrimestre3` DECIMAL(8,2) NOT NULL,
  `Trimestre3` DECIMAL(8,2) NULL,
  `abrevTrimestre3` VARCHAR(45) NOT NULL,
  `porcentajeTrimestre4` DECIMAL(8,2) NOT NULL,
  `Trimestre4` DECIMAL(8,2) NULL,
