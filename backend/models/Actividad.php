        ...
        public function generaCorrelativoActividad () {
            if (is_int($this->idDimension)) {
                ...
                if ($stmt->execute()) {
                    ...
                    $correlativoActividad = $_SESSION['abrev'] . '_' . $data->anioActividad . '_' . $data->idDimension . '.' . $data->numeroActividad;
                    return array(
                        'status' => SUCCESS_REQUEST,
                ...
                try {
                    ...
                    if ($stmt->execute()) {
                        ...
                        if($insertaCostos==true) {
                            return array(
                                'status'=> SUCCESS_REQUEST,
                                'data' => array('message' => 'La actividad fue insertada exitosamente')
                            );
                        } else {
                            return array(
                                'status'=> BAD_REQUEST,
