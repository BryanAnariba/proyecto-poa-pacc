...
CREATE TABLE IF NOT EXISTS `poa-pacc-bd`.`ObjetivoInstitucional` (
  ...
  `objetivoInstitucional` VARCHAR(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `poa-pacc-bd`.`ResultadoInstitucional` (
  ...
  `resultadoInstitucional` VARCHAR(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `poa-pacc-bd`.`DepartamentoPorDimension` (
  ...
  CONSTRAINT `fk_DepartamentoPorDimension_Departamento1`
    ...
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
alter table areaEstrategica modify Column areaEstrategica TEXT;
alter table ResultadoInstitucional modify Column resultadoInstitucional TEXT;
alter table ObjetivoInstitucional modify Column objetivoInstitucional TEXT;
