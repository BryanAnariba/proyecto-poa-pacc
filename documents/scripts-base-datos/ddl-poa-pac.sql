...
CREATE TABLE IF NOT EXISTS `poa-pacc-bd`.`AreaEstrategica` (
  ...
  `areaEstrategica` VARCHAR(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `poa-pacc-bd`.`ResultadoInstitucional` (
  ...
  INDEX `fk_ResultadoInstitucional_ObjetivoInstitucional1_idx` (`idObjetivoInstitucional` ASC) VISIBLE,
  INDEX `fk_ResultadoInstitucional_EstadoDCDUOAO1_idx` (`idEstadoResultadoInstitucional` ASC) VISIBLE,
  CONSTRAINT `fk_ResultadoInstitucional_ObjetivoInstitucional1`
    FOREIGN KEY (`idObjetivoInstitucional`)
    REFERENCES `poa-pacc-bd`.`ObjetivoInstitucional` (`idObjetivoInstitucional`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `poa-pacc-bd`.`LlenadoActividadDimensionUsuario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `poa-pacc-bd`.`LlenadoActividadDimensionUsuario` (
  `idLlenadoActividadDimensionUsuario` INT NOT NULL AUTO_INCREMENT,
  `idLlenadoDimension` INT NOT NULL,
  `idPersonaUsuario` INT NOT NULL,
  PRIMARY KEY (`idLlenadoActividadDimensionUsuario`),
  INDEX `fk_LlenadoActividadDimensionUsuario_LlenadoActividadDimensi_idx` (`idLlenadoDimension` ASC) VISIBLE,
  INDEX `fk_LlenadoActividadDimensionUsuario_Usuario1_idx` (`idPersonaUsuario` ASC) VISIBLE,
  CONSTRAINT `fk_LlenadoActividadDimensionUsuario_LlenadoActividadDimension1`
    FOREIGN KEY (`idLlenadoDimension`)
    REFERENCES `poa-pacc-bd`.`LlenadoActividadDimension` (`idLlenadoDimension`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_LlenadoActividadDimensionUsuario_Usuario1`
    FOREIGN KEY (`idPersonaUsuario`)
    REFERENCES `poa-pacc-bd`.`Usuario` (`idPersonaUsuario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
