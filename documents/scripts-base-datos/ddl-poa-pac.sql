...
CREATE TABLE IF NOT EXISTS `poa-pacc-bd`.`Actividad` (
  ...
  `resultadosUnidad` VARCHAR(200) NOT NULL,
...
ALTER TABLE DescripcionAdministrativa ADD COLUMN nombreActividad VARCHAR(150) NOT NULL;
ALTER TABLE DescripcionAdministrativa modify COLUMN nombreActividad TEXT;
ALTER TABLE ACTIVIDAD MODIFY COLUMN actividad VARCHAR(255)
ALTER TABLE Actividad MODIFY COLUMN resultadosUnidad VARCHAR(255)
