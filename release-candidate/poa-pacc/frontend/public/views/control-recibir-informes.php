...
<title>Control de Recibimiento de Informes</title>
...
<body id="body-pd">
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header indigo darken-4 text-white">
                        <h5 class="font-weight-bolder"> Maneja el control de los informes que recibes desde este panel</h5>
                    </div>
                        ...
                        <table class="table" id="listado-informesPendientes">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col"><center>Fecha Recibido</center></th>
    ...
    <!--Confirmar modificacion de estado del informe-->
    <div class="modal fade" id="modalConfirmarModificacionEstadoInforme" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xs" role="document">
            <div class="modal-content">
                <div class="modal-header indigo darken-4 text-white">
                    <h4 class="modal-title w-100" id="myModalLabel">Confirmar cambio de estado de informe</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form id="formulario-hacer-observaciones-solicitud" class="text-center" style="color: #757575;">
                        <div class="form-row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                <div class="md-form">
                                    <h5 align="center" style="color:#191970" >¿Confirmar la Aprobación del Informe Seleccionado?</h5>  
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    <div class="text-center mt-4">
                        <button id="btn-hacer-observacion" type="button" class="btn btn-light-green btn-rounded" onclick="modificaEstadoInformeSeleccionado()">
                            Confirmar
                        </button>
                    </div>
                    <div class="text-center mt-4">
    ...
    <script src="../js/control-recibir-informes/recibirInformes-controlador.js"></script>
